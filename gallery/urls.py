...
urlpatterns = [
    ...
    path('videos/all/', views.ImageView.as_view({'get': 'list'}), name='all-video'),
    path('videos/add/', views.ImageView.as_view({'post': 'create'}), name='add-image'),
    path('videos/<int:pk>/',views.ImageView.as_view({'get': 'retrieve'}), name='get-video'),
    path('videos/delete/<int:pk>/',views.ImageView.as_view({'get': 'destroy'}), name='delete-video'),
]
